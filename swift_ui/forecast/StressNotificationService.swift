...
private let logger = Logger(subsystem: "com.presagetech.smartspectra-swift-ui", category: "StressNotificationService")
...
final class SystemStressNotifier: StressNotifying {
    ...
    func requestAuthorizationIfNeeded() async {
        ...
        do {
            ...
            logger.notice("Notification authorization not granted: \(error.localizedDescription, privacy: .public)")
        }
    }
